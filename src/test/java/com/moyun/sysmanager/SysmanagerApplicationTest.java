...
public class SysmanagerApplicationTest {
    ...
    @Test
    public void test() {
//        log.info("操作时间({})--菜单域名更新成功（切换操作）", DateUtil.formatFullTime(LocalDateTime.now(),FULL_TIME_SPLIT_PATTERN));
...
//        String link_1="http://27.159.82.162:10135/dws/domain/createWxShortUrl?url=http://olrs.jm9l.top";
//        Map map = new HashMap<>();
